...
class AppConfigRepository {
  Future<MyResponse> updateLanguage(Language language) async {
    await SharedPreferenceHandler().putLanguageCode(language.languageCode);
    ...
    return MyResponse.complete(language);
  }
}
